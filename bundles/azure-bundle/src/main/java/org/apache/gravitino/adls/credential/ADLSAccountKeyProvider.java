...
package org.apache.gravitino.adls.credential;
...
/** Generates ADLS account key credential to access ADLS data. */
public class ADLSAccountKeyProvider implements CredentialProvider {
  ...
  public void initialize(Map<String, String> properties) {
    ...
    this.accountName = adlsCredentialConfig.accountName();
    this.accountKey = adlsCredentialConfig.accountKey();
  }
  ...
  public String credentialType() {
    return ADLSAccountKeyCredential.ADLS_ACCOUNT_KEY_CREDENTIAL_TYPE;
  }

...
For more details about `CALL`, please refer to the [Spark Procedures description](https://iceberg.apache.org/docs/1.6.0/spark-procedures/#spark-procedures) in Iceberg official document.

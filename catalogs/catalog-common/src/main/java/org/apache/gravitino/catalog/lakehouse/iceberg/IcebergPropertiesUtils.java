...
public class IcebergPropertiesUtils {
  ...
  static {
    ...
    // ADLS
    map.put(ADLSProperties.GRAVITINO_ADLS_ACCOUNT_NAME, IcebergConstants.ICEBERG_ADLS_ACCOUNT_NAME);
    map.put(ADLSProperties.GRAVITINO_ADLS_ACCOUNT_KEY, IcebergConstants.ICEBERG_ADLS_ACCOUNT_KEY);
